...
export type Theme = "neon" | "vaporwave" | "emerald" | "steel";

export const THEMES: { id: Theme; name: string; primary: string; bg: string }[] = [
  { id: "neon", name: "Neon Cyber", primary: "#e8ff47", bg: "#0c0c0c" },
...
export function setTheme(theme: Theme) {
  ...
  root.classList.remove("theme-neon", "theme-vaporwave", "theme-emerald", "theme-steel");
